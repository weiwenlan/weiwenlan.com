...
export default function IntroCard({ index = 0 }: IntroCardProps) {
  return (
    <BaseCard index={index}>
      ...
      <div className="reveal-text relative z-[var(--z-content)] w-full h-full flex flex-col justify-center px-[5.3%] font-sans font-semibold tracking-tight text-[clamp(56px,8vw,120px)] leading-[1.1]">
        <div>Wenlan Wei</div>
